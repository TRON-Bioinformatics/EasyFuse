...
- A model can now be selected with the `--model_pred` option, by default is set to EF_full
- Model-tool compatibility checks have been added

### Code Refactoring
- the `EF_full_rep` model has been removed from the repository
