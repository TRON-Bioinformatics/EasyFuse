...
def add_annotation_parser_args(parser):
    parser.add_argument(
        "--detected_fusions",
        dest="detected_fusions",
        help="detected_fusions.csv file from easyfuse",
        required=True,
    )
    parser.add_argument(
        "--annotation_db",
    ...
    parser.add_argument(
        "--out_csv",
        dest="out_csv",
        help="context_seqs.csv output for easyfuse",
        required=True,
    )
    parser.add_argument(
        "--genome_fasta",
    ...
    parser.set_defaults(func=annotation_command)


def annotation_command(args):
