...
class DataJoining(object):
    ...
    def create_joined_table(self, sample_id, fusion_tools, requant_mode):
        ...
        context_seq_file = os.path.join(self.input_dir, "Sample_{}".format(sample_id), "fetchdata",
                                        "fetched_contextseqs", "Context_Seqs.csv")
        detect_fusion_file = os.path.join(self.input_dir, "Sample_{}".format(sample_id), "fetchdata",
        ...
        requant_cpm_file = os.path.join(self.input_dir, "Sample_{}".format(sample_id), "fetchdata",
                                        "classification", "classification_{}.tdt".format(requant_mode))
        requant_cnt_file = os.path.join(self.input_dir, "Sample_{}".format(sample_id), "fetchdata",
