from bin.fusionannotation import breakpoints_to_dict

class TestFusionAnnotation:
    input_fusions = "tests/fusionannotation/Detected_Fusions.csv"

    def test_breakpoints_to_dict(self):
        print(breakpoints_to_dict(self.input_fusions))
        assert breakpoints_to_dict(self.input_fusions) == {
